...
//+
Transfinite Curve {211, 221} = frontLoveResolution Using Progression frontLoveProgression;
//+
Transfinite Curve {209, 219, 210, 218, 214, 215} = verticalResolution Using Progression verticalProgression;
//+
Transfinite Curve {212, 222, 223, 217} = wingFlankResolution Using Progression wingFlankProgression;
//+
Transfinite Curve {216, 220, 213} = trailResolution Using Progression trailProgression;
//+
Curve Loop(1) = {219, 213, 214, -220};
//+
Plane Surface(1) = {1};
//+
Curve Loop(2) = {220, 215, 216, 218};
//+
Plane Surface(2) = {2};
//+
Curve Loop(3) = {223, 210, -217, 218};
//+
Plane Surface(3) = {3};
//+
Curve Loop(4) = {210, 211, -209, 221};
//+
Plane Surface(4) = {4};
//+
Curve Loop(5) = {222, 219, -212, -209};
//+
Plane Surface(5) = {5};
//+
